...
| P1 | Pending | Hardening | Nonce, authorization, validation, escaping, and upload checks are verified. |
| P1 | Pending | Runtime verification | Activate in WordPress and run the README manual verification matrix. |
